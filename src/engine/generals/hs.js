...
export const HS_GENERALS = {
  ...
  loatheb: {
    ...
    skills: ['duwu', 'baozi'],
    bio: '毒雾：指定一名角色，直到你下回合开始，其每使用一张牌前须弃掉一张点数更大的牌，否则不能使用。孢子（锁定技）：当你受到一次伤害后，使下一张被使用的【杀】伤害+1。',
  },
  ...
  alleria: {
    ...
    bio: '利箭：指定一名角色弃1张牌，你对其造成1点强制伤害。箭语（锁定技）：你用牌造成伤害后重置【利箭】。',
  },
  tyrande: {
    id: 'tyrande', name: '泰兰德', faction: FACTION.ALLIANCE, hp: 3, title: '月神之力',
    skills: ['huoshi', 'liuxing'],
    bio: '火矢（锁定技）：你的【杀】对手牌数>5的角色多造成1点伤害。流星雨：指定一名角色，其交给你一张牌或受到1点伤害（每回合一次）。',
  },
