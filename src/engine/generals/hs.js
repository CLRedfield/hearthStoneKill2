...
export const HS_GENERALS = {
  ...
  loatheb: {
    id: 'loatheb', name: '洛欧塞布', faction: FACTION.SCOURGE, hp: 6, title: '沼泽毒菌',
    skills: ['duwu', 'baozi'],
    bio: '毒雾：指定一名角色，直到你下回合开始，其每使用一张牌前须自行选择弃掉一张点数更大的牌，否则不能使用。孢子（锁定技）：当你受到一次伤害后，使下一张被使用的【杀】对除你以外的目标伤害+1。',
  },
  ...
  chenyong: {
    ...
    skills: ['binhuo', 'aoshu'],
    bio: '冰火（锁定技）：你对有装备的角色造成的伤害+1；你的伤害性牌造成伤害后冻结其1张手牌；你的手牌无法被冻结。奥数（锁定技）：你冻结的每张牌解冻时，其拥有者抉择：①使你摸2张；②弃掉该牌并选择1张手牌交给你。',
  },
